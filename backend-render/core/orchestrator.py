...
_KEYWORD_ROUTES = [
    (["write code", "code for", "program to", "script to", "write a function", "write python", "write javascript", "write java", "debug this", "fix this code", "explain this code", "refactor", "how to code", "implement"], "coding"),
    (["generate image", "create image", "draw", "make a picture", "make an image", "generate a photo", "create art", "generate art", "paint"], "image"),
    (["open ", "close ", "launch ", "play ", "youtube", "volume", "brightness", "wifi", "bluetooth", "screenshot", "photo", "lock", "shutdown", "restart", "battery", "call ", "take photo", "gallery", "files", "storage", "notification", "note ", "remind ", "write note", "increase", "decrease", "dim", "turn up", "turn down", "turn on", "turn off", "search ", "google", "browser", "camera", "spotify", "calc", "telegram", "whatsapp", "sms", "inbox", "message", "contacts", "song", "music", "media", "next ", "previous ", "pause ", "wallpaper", "location", "share ", "call log", "what time", "current time", "check time"], "task"),
