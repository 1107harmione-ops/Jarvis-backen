...
class TaskAgent(BaseAgent):
    ...
    TASK_MAP = {
        ...
        "open drive": ("open_app", "drive"),
        "open photos": ("open_app", "photos"),
        "open brave": ("open_app", "brave"),
        "open discord": ("open_app", "discord"),
        "open snapchat": ("open_app", "snapchat"),
        "open amazon": ("open_app", "amazon"),
        "open phonepe": ("open_app", "phonepe"),
        "open gpay": ("open_app", "gpay"),
        "open google pay": ("open_app", "google pay"),
        "open truecaller": ("open_app", "truecaller"),
        "open tiktok": ("open_app", "tiktok"),
        "open telegram x": ("open_app", "telegram x"),
        "open termux": ("open_app", "termux"),
        "open github": ("open_app", "github"),
        "open gemini": ("open_app", "gemini"),
        "open translate": ("open_app", "translate"),
